...
Used to support the translation feature of the website. Users can select different languages and translate text displayed on the application. Selecting English restores the original content.
...
Choose English to return the website to its original version.
